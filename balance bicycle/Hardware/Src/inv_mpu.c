...
#include "i2c.h"
#define i2c_write(dev_addr, reg_addr, size, pData) \
        HAL_I2C_Mem_Write(&hi2c1, dev_addr, reg_addr, I2C_MEMADD_SIZE_8BIT, pData, size, 0xF)
#define i2c_read(dev_addr, reg_addr, size, pData) \
        HAL_I2C_Mem_Read(&hi2c1, dev_addr, reg_addr, I2C_MEMADD_SIZE_8BIT, pData, size, 0xF)
